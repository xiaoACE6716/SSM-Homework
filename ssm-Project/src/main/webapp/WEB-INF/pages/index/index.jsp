            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div style="position: relative; left: 40px;">
                        姓名：<b>${sessionScope.sessionUser.nickName}</b><br>
                        <br> 登录帐号：
                        <b>${sessionScope.sessionUser.userName}</b><br>
                        <br> 邮箱：
                        <b>${sessionScope.sessionUser.email}</b><br>
                        <br> 电话号码：
                        <b>${sessionScope.sessionUser.phonenumber}</b><br>
                    </div>
                </div>
            ...
            <ul>
                <li class="dropdown user-dropdown">
                    <a href="javascript:void(0)" style="text-decoration: none; color: white;" class="dropdown-toggle" data-toggle="dropdown">
                        <span class="glyphicon glyphicon-user"></span> ${sessionScope.sessionUser.nickName} <span class="caret"></span>
                    </a>
    ...
    <div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
        ...
        <div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
            ...
            <ul id="no1" class="nav nav-pills nav-stacked">
                ...
                <li class="liClass"><a href="listAllRole.do" target="workareaFrame"><span class="glyphicon glyphicon-user"></span> 角色维护</a></li>
            </ul>
